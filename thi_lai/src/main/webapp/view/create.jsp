...
<form method="post" class="container w-50">
    <div>
        ...
        <div class="input-group mb-4">
            ...
            <input required value="${product.price}" name="price" type="text" aria-label="Last name"
                   class="form-control">
        ...
        <div class="input-group mb-4">
            ...
            <input required value="${product.quantity}" name="quantity" type="text" aria-label="Last name"
                   class="form-control">
            <%--            <small class="col-md-12" style="color: red"> ${error.area}</small>--%>
        </div>
        <div class="input-group mb-4">
            ...
            <input required value="${product.color}" name="color" type="text" aria-label="Last name"
                   class="form-control">
            <%--            <small class="col-md-12" style="color: red"> ${error.area}</small>--%>
        </div>
        <div class="input-group my-4">
