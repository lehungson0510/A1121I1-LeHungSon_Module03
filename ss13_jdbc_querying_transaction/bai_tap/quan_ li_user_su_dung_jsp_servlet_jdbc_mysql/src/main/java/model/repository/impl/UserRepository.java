...
public class UserRepository implements IUserRepository {
    ...
    private static final String DELETE_USERS_PROCEDURE = "CALL delete_user(?)";
    ...
    private static final String SELECT_ALL_USERS_PROCEDURE = "CALL select_all_user()";
    private static final String UPDATE_USERS_SQL_PROCEDURE = "CALL update_user(?,?,?,?)";
...
//    *************** Xoá cũng được*******************
    ...
    public List<User> selectAllUserProcedure() {
        ...
        try (Connection connection = BaseRepository.getConnect();
             ...
             // Step 2:Create a statement using connection object
             PreparedStatement preparedStatement = connection.prepareStatement(SELECT_ALL_USERS_PROCEDURE);) {
            System.out.println(preparedStatement);
            // Step 3: Execute the query or update query
            ResultSet rs = preparedStatement.executeQuery();
...
//           đọc từ database
    ...
    public boolean deleteUserProcedure(int id) throws SQLException {
        boolean rowDeleted;
        try (Connection connection = BaseRepository.getConnect();
             PreparedStatement statement = connection.prepareStatement(DELETE_USERS_PROCEDURE);) {
    ...
    public boolean updateUserProcedure(User user) throws SQLException {
        boolean rowUpdated;
        try (Connection connection = BaseRepository.getConnect();
             PreparedStatement statement = connection.prepareStatement(UPDATE_USERS_SQL_PROCEDURE);) {
